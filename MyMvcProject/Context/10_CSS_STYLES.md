# CSS Stylesheets (wwwroot/css/)

## site.css (Dark Theme - Default)
```css
/* ============================================
   PORTFOLIO - DARK THEME (Default)
   ============================================ */
...
:root {
    ...
    --gradient-text: linear-gradient(135deg, #0ea5e9 0%, #8b5cf6 50%, #a855f7 100%);
...
.hero-glow {
    ...
    width: 120%;
    height: 120%;
    background: radial-gradient(circle, rgba(14, 165, 233, 0.2) 0%, rgba(139, 92, 246, 0.1) 40%, transparent 70%);
    border-radius: 50%;
    filter: blur(40px);
...
.code-2 { top: 50%; right: -15%; animation-delay: 2s; }
.code-3 { bottom: 15%; left: 5%; animation-delay: 4s; }
...
.project-image-wrapper:hover .project-link {
...
/* ============================================
   PAGE HERO (About, Contact, Courses, Blog, Projects)
   ============================================ */
.page-hero {
...
.info-icon.email-icon { background: linear-gradient(135deg, #0ea5e9, #0284c7); }
.info-icon.phone-icon { background: linear-gradient(135deg, #10b981, #059669); }
.info-icon.location-icon { background: linear-gradient(135deg, #f59e0b, #d97706); }
.info-icon.linkedin-icon { background: linear-gradient(135deg, #0077b5, #005885); }
...
.blog-card-full .blog-image-wrapper {
    aspect-ratio: 16/10;
    height: 100%;
}

.blog-card-full .blog-content-inner {
    padding: 32px;
}
